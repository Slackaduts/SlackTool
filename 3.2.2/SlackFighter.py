		...
		while True:
			if self.selected_spell:
				...
				if 'AOE' in selected_spell_logic:
					...
					await self.selected_spell.cast(None, sleep_time=0.22)
					...
					await self.selected_spell.cast(self.selected_enemy, sleep_time=0.22)
					...
					await self.selected_spell.cast(self.selected_ally, sleep_time=0.22)
